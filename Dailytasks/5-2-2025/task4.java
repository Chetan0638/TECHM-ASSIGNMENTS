	...
	public static void main(String[] args) throws SQLException, Exception {
		...
		do {
			...
			switch (choice) {
				...
				case 2:
					st = con.prepareStatement("Update Student set name = ? where student_id = ?;");
				...
				case 3:
					st = con.prepareStatement("Delete from Student where student_id = ?;");
				...
				case 4:
					st = con.prepareStatement("Select * from Student where student_id = ?");
